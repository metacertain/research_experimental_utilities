...
{ { {"POST", "/soc/\\{owner\\}/\\{id\\}?span=\\{span\\}", 				"Create new single owner chunk as in \\ref{def:soc-store} "} 									},	{ {"owner", "hex string", "eth address of single owner"}, {"id", "hex string", "identifier within owner namespace"} 						},	{ {"SWARM-TAG", "hex string", "" }, {"SWARM-STAMP", "hex string", ""}, {"SWARM-ENCRYPTION", "hex string", ""}, {"SWARM-PIN", "bool", ""}, {"SWARM-PARITIES", "integer", ""} 	} 	,	{ {"span", "string", ""}				 								}  , 	{ { "200", "Ok", "" } 																									} }, 
